...
class Student(models.Model):
    ...
    branch = models.CharField(_('Branch'), max_length=32, blank=True, null=True,
                                  validators=[RegexValidator(regex='^[A-Za-z]*$')])
    tenth_mark = models.FloatField(_('10th Mark'), max_length=32, blank=True, null=True)
    twelth_mark = models.FloatField(_('12th Mark'),max_length=32, blank=True, null=True)
...
TYPES = (('Technical', _('Technical')), ('HR', _('HR')),
