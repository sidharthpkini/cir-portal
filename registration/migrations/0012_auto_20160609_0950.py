...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='student',
            name='name',
            field=models.CharField(max_length=32, null=True, verbose_name='Name', blank=True),
        ),
        migrations.AlterField(
            model_name='student',
            name='s1',
        ...
        migrations.AlterField(
            model_name='student',
            name='tenth_mark',
            field=models.FloatField(max_length=32, null=True, verbose_name='10th Mark', blank=True),
        ),
        migrations.AlterField(
            model_name='student',
            name='twelth_mark',
            field=models.FloatField(max_length=32, null=True, verbose_name='12th Mark', blank=True),
        ),
    ]
